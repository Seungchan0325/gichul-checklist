...
import { BookOpen, Check, CircleX, Clock3, Download, ExternalLink, Home, LogOut, Menu, Moon, Pause, Play, RotateCcw, Settings, Sun, X } from 'lucide-react'
...
import { loadAllExamSubjects, loadAnswerKeys, loadAttemptedExams, loadBootstrap, saveAttempt, saveTheme, toggleShortcut, type AttemptedExamItem, type CategorizedExamItem, type ExamListItem, type Subject } from './lib/data'

type Page = 'home' | 'subjects' | 'list' | 'exam' | 'settings'
...
function Header({ page, setPage, dark, setDark }: { page: Page; setPage: (page: Page) => void; dark: boolean; setDark: (value: boolean) => void }) {
  const [mobile, setMobile] = useState(false)
  const navItems: Array<[Page, string]> = [['home', '홈'], ['subjects', '기출문제'], ['settings', '설정']]
