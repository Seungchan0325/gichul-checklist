...
import { createExamPdfUrl, deleteAccount, loadAllExamSubjects, loadAnswerKeys, loadAttemptedExams, loadBootstrap, saveAttempt, saveTheme, toggleShortcut, type AttemptedExamItem, type CategorizedExamItem, type ExamListItem, type Subject } from './lib/data'
...
function ExamPage({ user, exam, subject, onSaved }: { user: User; exam: ExamListItem; subject: Subject; onSaved: (attempt: Awaited<ReturnType<typeof saveAttempt>>) => void }) {
